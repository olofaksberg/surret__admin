...
import { PageMainMarkets, PageMainProducts, PageMainOrders, PageAddMarkets, PageAddProducts, PageEditMarket, PageEditProduct, PageError } from '@/components/pages';
    ...
    return (
        <Routes>
          ...
          <Route
            ...
            path={clientEndpoints().PRODUCTS.ADD}
          />
          <Route
          ...
          />
          <Route
            element={<PageMainMarkets />}
            path={clientEndpoints().MARKETS.MAIN}
          />
          <Route
            element={<PageAddMarkets />}
            path={clientEndpoints().MARKETS.ADD}
          />
          <Route
          ...
          />
          <Route
            element={<PageMainOrders />}
            path={clientEndpoints().ORDERS.MAIN}
          />
